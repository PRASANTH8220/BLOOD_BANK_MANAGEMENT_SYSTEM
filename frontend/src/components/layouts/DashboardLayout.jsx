...
const DashboardLayout = ({ userRole = "donor" }) => {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      ...
      console.error("All retries failed. Redirecting to login.");
      localStorage.removeItem("token");
      navigate("/login");
      setIsLoading(false);
    };
                ...
                return (
                  ...
                  >
                    <Icon
                      ...
                      style={{ color: isActive ? "white" : theme.primary[600] }}
                    />
                    {!sidebarCollapsed && (
                      <>
          ...
          {!sidebarCollapsed && (
            <div className="p-4 border-t border-red-100">
              <div
                ...
                style={{ background: theme.primary[100], color: theme.primary[700] }}
              >
